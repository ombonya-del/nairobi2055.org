...
(function(){
  ...
  window.getVizKey = function(t){
    ...
    if(u.includes('NAIROBI 2055 ACT')||u.includes('STATUTORY ENTRENCHMENT')) return 'ACT2055';
  ...
  document.addEventListener('DOMContentLoaded',function(){
    addVIZ('EV_CARGO_TRIKE','Cargo E-Trike Network','80,000 operators','viz-tpl-ev_cargo_trike-map','viz-tpl-ev_cargo_trike-panel');
    addVIZ('E_MKOKOTENI','E-Mkokoteni — Handcart Journey','Voluntary buyback · Dignity','viz-tpl-e_mkokoteni-map','viz-tpl-e_mkokoteni-panel');
    addVIZ('MKOKOTENI_TECH','Mkokoteni E-Trike — The Vehicle','Specs · Hire-purchase','viz-tpl-mkokoteni_tech-map','viz-tpl-mkokoteni_tech-panel');
    addVIZ('ACT2055','Nairobi 2055 Act','County · National · Senate','viz-tpl-act2055-map','viz-tpl-act2055-panel');
  });
})();
